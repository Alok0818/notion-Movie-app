...
export default function Updatemovie() {
  ...
  const getDataFromParam = () => {
    axios.get(`http://localhost:2344/movies/id/${id}`).then((res) => { setData(res.data); setName(res.data.Name); setTitle(res.data.title); setRating(res.data.Rating); setCategory(res.data.Category); setPrice(res.data.Price) })
  }
  useEffect(() => {
    getDataFromParam()
  }, [])
